...
export function SettingsModal({ muted, onToggleMute, onClose }: Props) {
  ...
  return (
    <div className="fishing-dock-screen__backdrop" onClick={onClose}>
      <section
        className="w-[min(380px,100%)] rounded-[32px] bg-white border-2 border-slate-300 border-b-[4px] overflow-hidden flex flex-col"
        role="dialog"
        aria-modal="true"
        ...
        <div className="p-6 space-y-4 bg-white">
          ...
          <div className="flex items-center justify-between p-4 rounded-[20px] bg-white border-2 border-slate-300 border-b-[3px]">
            ...
            <button
              ...
              className={`w-[80px] py-2.5 rounded-xl font-black uppercase text-sm transition-all flex items-center justify-center border border-slate-300 border-b-[3px] active:border-b active:translate-y-[2px] ${
                !muted
